...
interface MainLayoutProps {
  children: ReactNode
  currentTab: 'agenda' | 'eventos' | 'series' | 'calendario' | 'avisos' | 'cadastro' | 'portaria' | 'relatorios' | 'auditoria' | 'regionais' | 'administracoes' | 'setores' | 'casas' | 'grupos-trabalho' | 'membros' | 'funcoes' | 'vinculos-funcionais' | 'locais'
  onTabChange: (tab: 'agenda' | 'eventos' | 'series' | 'calendario' | 'avisos' | 'cadastro' | 'portaria' | 'relatorios' | 'auditoria' | 'regionais' | 'administracoes' | 'setores' | 'casas' | 'grupos-trabalho' | 'membros' | 'funcoes' | 'vinculos-funcionais' | 'locais') => void
      ...
      <nav className="bg-white border-t border-slate-200 fixed bottom-0 w-full z-10 safe-area-bottom">
        <div className="max-w-2xl mx-auto flex justify-between items-center px-2 py-2">
          ...
          <button 
            ...
            className={`flex flex-col items-center flex-1 p-2 rounded-lg transition-colors ${currentTab === 'series' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center flex-1 p-2 rounded-lg transition-colors ${currentTab === 'locais' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center flex-1 p-2 rounded-lg transition-colors ${currentTab === 'vinculos-funcionais' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
