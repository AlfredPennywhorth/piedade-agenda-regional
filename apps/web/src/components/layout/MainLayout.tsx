      ...
      <nav className="bg-white border-t border-slate-200 fixed bottom-0 w-full z-10 safe-area-bottom">
        ...
        >
          ...
          <button 
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'agenda' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button 
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'eventos' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button 
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'series' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
            <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
            <span className="text-[10px] font-medium">Séries</span>
          </button>

          <button 
            onClick={() => onTabChange('convocacoes')} 
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'convocacoes' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
            ...
            <span className="text-[10px] font-medium">Convocações</span>
          </button>

          <button 
            onClick={() => onTabChange('calendario')} 
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'calendario' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
            <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
          ...
          {mostrarPortaria && (
            <button
              ...
              className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'portaria' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
            >
          ...
          {mostrarRelatorios && (
            <button
              ...
              className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'relatorios' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
            >
          ...
          {mostrarAdministracaoAcessos && (
            <button
              ...
              className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'acessos' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
            >
          ...
          {mostrarAuditoria && (
            <button
              ...
              className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'auditoria' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
            >
          ...
          <button
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'avisos' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'regionais' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'administracoes' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
            <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m0 0h4m-4 0V9a2 2 0 012-2h2a2 2 0 012 2v12" /></svg>
          ...
          <button
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'setores' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
            <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m0 0h4m-4 0V9a2 2 0 012-2h2a2 2 0 012 2v12" /></svg>
          ...
          <button
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'casas' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'grupos-trabalho' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'locais' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
            <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
            <span className="text-[10px] font-medium">Locais</span>
          </button>

          <button
            onClick={() => onTabChange('membros')}
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'membros' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'funcoes' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
            <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
          ...
          <button
            onClick={() => onTabChange('vinculos-funcionais')}
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'vinculos-funcionais' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
            <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
            <span className="text-[10px] font-medium">Vínculos</span>
          </button>


          <button
            onClick={() => onTabChange('cadastro')}
            className={`flex flex-col items-center w-20 shrink-0 p-2 rounded-lg transition-colors ${currentTab === 'cadastro' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'}`}
          >
